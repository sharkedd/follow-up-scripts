...
export const filePath = "./excel/base de datos 27 y 28 de enero.xlsx"; // Ruta del archivo a leer
export const newFilePath = "excel/filas_copiadas.xlsx"; // Ruta donde se almacenará el archivo filtrado
export const newExcelName = "filas_copiadas";

// CONSTANTES DE SELECCIÓN
export const fecha_facturacion = "27-01-2025 0:00:00"; // Se seleccionarán las filas que tengan esta fecha de facturación
