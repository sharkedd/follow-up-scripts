...
export const filePath = "./excel/Base de Datos 11 a hoy.xlsx"; // Ruta del archivo a leer
export const newFilePath = "cargas/Carga (11-12)-02.xlsx"; // Ruta donde se almacenará el archivo filtrado
export const newExcelName = "filas_copiadas";

// CONSTANTES DE SELECCIÓN
export const fecha_facturacion = "11-02-2025 0:00:00"; // Se seleccionarán las filas que tengan esta fecha de facturación
export const fecha_facturacion2 = "12-02-2025 0:00:00"; // Se seleccionarán las filas que tengan esta fecha de facturación
